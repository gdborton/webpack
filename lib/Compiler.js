...
const farmManager = require("./parallel/manager");
...
class Compiler extends Tapable {
	...
	createResolverWith(resolverOptions) {
		return farmManager.createResolverWith(resolverOptions);
	}

	compile(callback) {
		this.manager = farmManager.startFarm(this);
