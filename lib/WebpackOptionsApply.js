...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler) {
		...
		compiler.resolvers.normal = compiler.createResolverWith(Object.assign({
			fileSystem: compiler.inputFileSystem
		}, options.resolve));
		compiler.resolvers.context = compiler.createResolverWith(Object.assign({
			fileSystem: compiler.inputFileSystem,
			resolveToContext: true
		}, options.resolve));
		compiler.resolvers.loader = compiler.createResolverWith(Object.assign({
			fileSystem: compiler.inputFileSystem
		}, options.resolveLoader));
